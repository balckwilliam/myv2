...
install_v2ray() {
	...
	if [[ $local_install ]]; then
		...
		pushd /tmp
		if [[ $_test ]]; then
			wget https://github.com/balckwilliam/myv2/raw/master/v2ray-3.05.zip
			unzip v2ray-3.05.zip
			mkdir -p /etc/v2ray/233boy
			mv ./v2ray-3.05 /etc/v2ray/233boy/v2ray
			chmod +x /etc/v2ray/233boy/v2ray/*.sh
		else
			wget https://github.com/balckwilliam/myv2/raw/master/v2ray-3.05.zip
			unzip v2ray-3.05.zip
			mkdir -p /etc/v2ray/233boy
